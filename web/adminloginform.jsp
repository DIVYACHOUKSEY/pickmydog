...
<html>
    ...
    <style>
        ...
        <script>
            function check()
            {
                if(adminloginform.aemail.value==0)
                    alert("email id is required");
                 if(adminloginform.apass.value==0)
   ...
   <body bgcolor="white">
        ...
        <div><br><br><br>
            <table align="center">
                ...
                <tr><td><center> <font style="color:#00BFFF;font-family: arial ;text-align:center">Admin login</font><centre></td></tr>
                </table>
            <br>
            <!---------------admin login form start-------------------------->
            <form action="adminlogincheck.jsp" name="adminloginform" method="POST">
            <table align="center" cellspacing="15px" style="background-color:#F0F8FF" >
                 ...
                 <tr>
                    <td>password</td>
                    <td><input type="pasword" name="apass"></td>
                </tr>
                 <tr>
                    <td><input type="submit" value="submit" style="background-color:#1E90FF; width:100%;   height:31px;border-radius:8px; color:white; text-align:center"onClick="check()" ></td>
                ...
                <tr><center><td><a href="adminforgetpassword.jsp">forget password</a></td></center></tr>
                </table>
                </form>
