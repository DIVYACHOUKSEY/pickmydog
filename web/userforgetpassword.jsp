   ...
   <body bgcolor="white">
    ...
    <div>
            ...
            <tr><td><img src="logis.png" width="100px" height="100px"></td></tr>
                <tr><td><center> <font style="color:#00BFFF;font-family: arial ;text-align:center"> User forget password</font><centre></td></tr>
                </table>
            <br>
            <!---------------------start of forget password form-------------------------->
            <div>
           <form action="userforgetpasswordcon.jsp" method="POST">
            <table align="center" cellspacing="15px" style="background-color:#F0F8FF">
                <tr>
                   ...
                   <tr>
                    ...
                    <td><input type="password" name="cf"></td>
                </tr>
                 <tr>
