...
PreparedStatement st=con.prepareStatement("select*from adoptdog_table where dog_category=?");
        ...
        //-------------------------------while loop start------------------------------
    while(rg.next()){%>
                <td style="width:20%;height:100%"  bgcolor="#F0F8FF"><%=rg.getBlob("dog_image")%></td>
                    ...
                    <table width="100%" height="100%" >
                         ...
                         <tr height="6%">
                            ...
                            <td >
                              ...
                              <font style="font-size:22;"> <%=rg.getString("dog_category")%></font>
                                </td></tr>
                            <tr><td style="width:80%;height:100px"><%=rg.getString("dog_description")%></td>
                            <td align="right">
                                <br><br><br>
                                <table>
                                    <tr>
                                       
                                        <td><a href="showdogdata.jsp?id=<%=rg.getString("dogid")%>"   style="text-decoration:none"> see more...</a></td>
                                    </tr>
                                    </table>
                                </td>
                            </tr>
