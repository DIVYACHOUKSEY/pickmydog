...
try{
    ...
    Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/pickmydog","root","root");
         ...
         PreparedStatement
        rg= con.prepareStatement("select*from complain_table where complainid=? ");
      rg.setInt(1,cids);
   ...
   %>
        ...
        <div class="outerdiv" Style=" width:100%; height:800px ">
            ...
            <br><br><br><br><br>
             <div>
            <br>
            <!---------------------complain reply form start-------------------------->
            <form action="complainreplycon.jsp" method="POST">
            <table bgcolor="white" align="center" cellspacing="20px"  style="background-color:#F0F8FF">
               <%
               if(rs.next()){
               %>
                <tr><input type="hidden" name="cid"  value="<%=rs.getString("complainid")%>">
                    <td>user name to send reply</td>
                    <td><input type="text" name="cnms" value="<%=rs.getString("complain_name")%>"></td>
                </tr>
                 <tr>
                 ...
                 <tr>
                    <td>complain solve by</td>
                    <td><input type="textarea" name="csolve"></td>
                </tr>
                 <tr>
                    <td>complain no</td>
                    <td><input type="number" name="csno"></td>
                </tr>
                <%}}catch(Exception ex){
                        ex.printStackTrace();
                       }%>
