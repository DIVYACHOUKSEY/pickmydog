                ...
                <tr>
                   <td>
                       ...
                       <img src="doglogo.png" width="100%" height="70px"></td>
                        ...
                        <td align="center"  ><a href="#" class="drag"><img src="call.png" width="14px" height="14px"><font style="color:#00BFFF;font-family: arial ;text-align:center;font-size: 12px"><i>  Helpline no</i></font></a></td>
                               </tr>
                            </table><br><br>
                            <!------------------------------------------start of menu----------------------------------->
                                    ...
                                    <table  width="100%" >
                                        <tr>  <td><font style="font-size:15px"><%=rg.getString("dog_category")%></font></td>
                                            ...
                                            <tr>
                                                ...
                                                <tr>
                                                    <td align="right"><font style="font-size:11px "> <a href="showdogdata.jsp?id=<%=rg.getString("dogid")%>" style="text-decoration:none ">See more...</a></font></td>
                                                    </tr>
                                    </table>
                                ...
                                <td>
                                    <table  width="100%" ><tr>
                                            ...
                                            <tr>
                                                ...
                                                <tr>
                                                    <td align="right"><font style="font-size:11px "> <a href="showdogdata.jsp?id=<%=rg6.getString("dogid")%>" style="text-decoration:none ">See more...</a></font></td>
                                                    </tr>
                                    ...
                                    <table  width="100%" >
                                        <tr>
                                            ...
                                            <tr>
                                                ...
                                                <tr>
                                                    <td align="right"><font style="font-size:11px "> <a href="showdogdata.jsp?id=<%=rg11.getString("dogid")%>" style="text-decoration:none ">See more...</a></font></td>
                                                    </tr>
                                    </table>
                                    ...
                                    <table  width="100%" >
                                        ...
                                        <tr>
                                            ...
                                            <tr>
                                                ...
                                                <tr>
                                                    <td align="right"><font style="font-size:11px "> <a href="showdogdata.jsp?id=<%=rg7.getString("dogid")%>" style="text-decoration:none ">See more...</a></font></td>
                                                    </tr>
                                    </table>
                                    ...
                                    <table  width="100%" >
                                        ...
                                        <tr>
                                            ...
                                            <tr>
                                                ...
                                                <tr>
                                                    <td align="right"><font style="font-size:11px "> <a href="showdogdata.jsp?id=<%=rg8.getString("dogid")%>" style="text-decoration:none ">See more...</a></font></td>
                                                    </tr>
                                    </table>
